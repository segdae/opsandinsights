...
export const metadata: Metadata = {
  title: "Writing",
  description:
    "Practitioner takes on AI, automation, and consulting. No fluff. By Shea Campbell.",
...
export default async function WritingPage() {
  ...
  return (
    <main className="max-w-2xl mx-auto px-6 pt-16 pb-16">
      <h1 className="font-serif text-4xl font-bold text-primary tracking-tight">Writing</h1>
